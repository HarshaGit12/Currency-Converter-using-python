...
root.title("Currency Converter - GUI")
 
Tops = Frame(root, bg = '#e6e5e5', pady=2, width=2000, height=100, relief="ridge")
Tops.grid(row=0, column=0)
 
headlabel = tk.Label(Tops, font=('lato black', 30, 'bold'), text='Currency Converter - GUI ',
                    bg='#e6e5e5', fg='black')
...
CurrenyCode_list = ["INR", "USD", "AUD", "CAD", "CNY", "DKK", "EUR", "GBP", "JPY"]
...
label1 = tk.Label(root, font=('lato black', 12, 'bold'), text="\t    Converted Amount:  ", bg="#e6e5e5", fg="black")
...
Label_9 = Button(root, font=('arial', 15, 'bold'), text="   Clear All  ", padx=2, pady=2, bg="blue", fg="white",
                 command=clear_all)
